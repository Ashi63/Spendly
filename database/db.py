...
def seed_db():
    ...
    expenses = [
        ...
        (user_id, 12.00,  "Transport",     "2026-04-03", "Bus pass"),
        ...
        (user_id, 80.00,  "Shopping",      "2026-04-12", "New shoes"),
        (user_id, 15.00,  "Other",         "2026-04-14", "Miscellaneous"),
        (user_id, 60.00,  "Food",          "2026-04-15", "Restaurant dinner"),
    ]
    conn.executemany(
